...
OwlCarousel.ɵfac = function OwlCarousel_Factory(t) { return new (t || OwlCarousel)(ɵngcc0.ɵɵdirectiveInject(core_1.IterableDiffers)); };
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(OwlCarousel, [{
    ...
    }], function () { return [{ type: core_1.IterableDiffers }]; }, { carouselClasses: [{
            type: core_1.Input
        }], options: [{
            type: core_1.Input
        }], items: [{
